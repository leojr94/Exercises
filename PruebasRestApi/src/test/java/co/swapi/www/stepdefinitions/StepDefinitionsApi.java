package co.swapi.www.stepdefinitions;

import static co.swapi.www.utilities.Constantes.BASE_URL;
import static co.swapi.www.utilities.Constantes.SLASH;
import static net.serenitybdd.screenplay.actors.OnStage.theActorCalled;
import static net.serenitybdd.screenplay.actors.OnStage.theActorInTheSpotlight;
import static net.serenitybdd.screenplay.rest.questions.ResponseConsequence.seeThatResponse;
import static org.hamcrest.Matchers.equalTo;

import co.swapi.www.task.ConsultFilm;
...
public class StepDefinitionsApi {	
	...
	public void idBase(int id) {
		...
		System.out.println(BASE_URL+id+SLASH);
		theActorInTheSpotlight().whoCan(CallAnApi.at(BASE_URL));
		theActorInTheSpotlight().attemptsTo(ConsultFilm.consultar(String.valueOf(id)+SLASH));
