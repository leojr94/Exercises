...
public class Empleado
{
    ...
    Fecha fecha2016 = new Fecha( 1, 1, 2016 ); // Crear el objeto fecha 2016 para comparacion
    ...
    {
    	double Ant= calcularAntiguedad( );
    	if(Ant==1) {
    		cambiarSalario(salario*1.15);
    	}
    	if(1<Ant & Ant<2) {
    		cambiarSalario(salario*1.18);    		
    	}
    	if(2<=Ant & Ant<3) {
    		cambiarSalario(salario*1.2);
    		
    	}
    	if(3<=Ant) {
    		cambiarSalario(salario*1.3);
    		
    	}
        return "Salario con incremento: "+ darSalario();
    }
    ...
    public String metodo2( )
    {
    	...
    	if(fechaIngreso.darAnio()<fecha2016.darAnio() & calcularEdad()<28) {
    		return "Se debe pagar una prima del: " + darSalario()*0.10;
    	}else return "No hay prima adicional " ;
        //return "Respuesta 2";
    }
