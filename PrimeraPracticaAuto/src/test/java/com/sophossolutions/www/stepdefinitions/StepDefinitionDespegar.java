...
public class StepDefinitionDespegar {
	...
	public void entreCiudades(String origen, String destino) {
		...
		actor.attemptsTo(BuscarVuelo.seleccionarVuelo(origen, destino, "2/2/2020", "7/2/2020"), ConfirmarVuelo.with());
	...
	public void validarValorVuelo() {
		...
		actor.should(seeThat(ValorVuelo.is(Confirmacionreserva.PRECIO), equalTo("403.531")));
